...
class DamageActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        recyclerView_damage.adapter = RecyclerViewAdapter()
        recyclerView_damage.layoutManager = GridLayoutManager(this, 2)

        // 검색 옵션 변수
        var searchOption = "name"

        // 스피너 옵션에 따른 동작
        spinner_damage.onItemSelectedListener = object: AdapterView.OnItemSelectedListener {
            ...
            override fun onItemSelected(
                ...
                when (spinner_damage.getItemAtPosition(position)) {
                    "제목" -> {
                        searchOption = "title"
                    }
                    "메모" -> {
        ...
        // 검색 옵션에 따라 검색
        searchBtn_damage.setOnClickListener {
            (recyclerView_damage.adapter as DamageActivity.RecyclerViewAdapter).search(searchWord_damage.text.toString(), searchOption)
        }
        ...
        plusbtn.setOnClickListener{
            val intent = Intent(this, DamageCreateActivity::class.java)
    ...
    inner class RecyclerViewAdapter : RecyclerView.Adapter<RecyclerView.ViewHolder>() {
        ...
        init {  // ContentDTO의 모델을 불러온 뒤 ContentDTOs으로 변환해 ArrayList에 담음
            firestore?.collection("damages")?.orderBy("timestamp", Query.Direction.DESCENDING)?.addSnapshotListener { querySnapshot, firebaseFirestoreException ->
                // ArrayList 비워줌
                ContentDTOs.clear()
        ...
        override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): RecyclerView.ViewHolder {
            ...
            return ViewHolder(view).apply {
                itemView.setOnClickListener {
                    ...
                    val intent2 = Intent(parent.context, DamageDetailActivity::class.java)
        ...
        override fun onBindViewHolder(holder: RecyclerView.ViewHolder, position: Int) {
            ...
            Glide.with(holder.itemView.context).load(ContentDTOs!![position].imageUrl).into(viewHolder.image_recycler)
        ...
        fun search(searchWord : String, option : String) {
            firestore?.collection("damages")?.addSnapshotListener { querySnapshot, firebaseFirestoreException ->
                // ArrayList 비워줌
                ContentDTOs.clear()
